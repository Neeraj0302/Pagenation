...
class Pager extends Template
{
    ...
    public function __construct(
        ...
        \Dolphin\MyModule\Model\Contact $customFactory, // Add your custom Model
        \Dolphin\MyModule\Model\ResourceModel\Contact\CollectionFactory $customdataCollection, // Add your custom Model
        array $data = []
    ) {
